  ...
  return (
            ...
            <ul className="navbar-nav ms-auto">
                ...
                <ul className="dropdown-menu">
                    <li><Link className="dropdown-item" to="/">HouseHold</Link></li>
                    <li><Link className="dropdown-item" to="/">Vehicle</Link></li>
                    <li><Link className="dropdown-item" to="/">Industrial</Link></li>
                </ul>
                </li>
                <li className="nav-item">
                <Link className="nav-link active" aria-current="page" to="/">News & Events</Link>
                </li>
                <li className="nav-item">
